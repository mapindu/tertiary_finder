...
<!-- Mirrored from crypto-admin-templates.multipurposethemes.com/sass/classic/pages/sample_blank.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Jul 2021 20:27:37 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <link rel="icon" href="http://crypto-admin-templates.multipurposethemes.com/sass/images/favicon.ico">

    <title>Tertiary Finder </title>
			  ...
			  <ul class="sidebar-menu" data-widget="tree">
				...
				<li class="treeview">
				  ...
				  <ul class="treeview-menu">
					...
					<li class="treeview">
					  <a href="#">
						<i class="ti-more"></i><span>Mailbox</span>
						<span class="pull-right-container">
						  <i class="fa fa-angle-right pull-right"></i>
						</span>
					  </a>
				...
				<li class="header nav-small-cap">UI & Widgets</li>		  
				...
				<li class="treeview">
				  ...
				  <ul class="treeview-menu">
					...
					<li class="treeview">
					  ...
					  <ul class="treeview-menu">
						<li class="treeview">
						  <a href="#"><i class="ti-more"></i>Utility 
							<span class="pull-right-container">
							  <i class="fa fa-angle-right pull-right"></i>
							</span>
						  </a>
						...
						<li class="treeview">
						  <a href="#"><i class="ti-more"></i>Typography
							<span class="pull-right-container">
							  <i class="fa fa-angle-right pull-right"></i>
							</span>
						  </a>
					...
					<li class="treeview">
					  ...
					  <ul class="treeview-menu">
						<li class="treeview">
						  <a href="#"><i class="ti-more"></i>Forms
							<span class="pull-right-container">
							  <i class="fa fa-angle-right pull-right"></i>
							</span>
						  </a>
				...
				<li class="treeview">
				  ...
				  <ul class="treeview-menu">
					<li class="treeview">
					  <a href="#"><i class="ti-more"></i>Widgets
						<span class="pull-right-container">
						  <i class="fa fa-angle-right pull-right"></i>
						</span>
					  </a>
...
<!-- ./wrapper -->
	...
	<script src="../../assets/vendor_components/perfect-scrollbar/dist/perfect-scrollbar.js"></script>
